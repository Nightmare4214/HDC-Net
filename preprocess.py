...
train_set = {
    'root': '/mnt/data/datasets/BraTS_2018/MICCAI_BraTS_2018_Data_Training',
    'flist': 'train.txt',
}
...
test_set = {
    'root': '/mnt/data/datasets/BraTS_2018/MICCAI_BraTS_2018_Data_Validation',
    'flist': 'test.txt',
}
...
def doit(dset):
    ...
    names = [os.path.basename(sub) for sub in subjects]
